...
public class ThongKe extends javax.swing.JPanel {
    ...
    private List<ThongKeJPN> list = new ArrayList<>();
    private ThongKeServiceimpl tks = new ThongKeServiceimpl();
    /**
    ...
    public ThongKe() {
        ...
        String[] tieuDe = {"Mã Sản Phẩm","Tên Sản Phẩm","Giá","Số Lượng","Doanh Thu"};
        dtm.setColumnIdentifiers(tieuDe);
        list = tks.getAll();
        showData(list);
    }
    public void showData(List<ThongKeJPN> list){
            dtm.setNumRows(0);
            for(ThongKeJPN tk : list){
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(30, 30, 30)
                .addComponent(txtTk, javax.swing.GroupLayout.PREFERRED_SIZE, 576, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(61, 61, 61)
